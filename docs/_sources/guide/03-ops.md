...
> ![](../_static/images/check.png) <b>NOTE</b><br>
...
> ![](../_static/images/check.png)참고<br>
...
<point>![](../_static/images/check.png) /etc/apt/sources.list 파일</point><br>
...
<point>![](../_static/images/check.png) pvetest에 대한 sources.list 항목</point><br>
```
deb http://download.proxmox.com/debian/pve bookworm pvetest
```

> ![](../_static/images/check.png)경고<br>
...
<point>![](../_static/images/check.png) /etc/apt/sources.list.d/ceph.list 파일</point><br>
...
<point>![](../_static/images/check.png) 예시: 고정 IP로 본딩 사용</point>
...
<point>![](../_static/images/check.png) 예시: 브릿지 포트로 본딩 사용</point>
...
<point>![](../_static/images/check.png) 게스트 네트워크용 VLAN</point><br>
...
<point>![](../_static/images/check.png) 호스트의 VLAN</point><br>
...
<point>![](../_static/images/check.png) 예시: 기존 Linux 브릿지를 사용하여 Proxmox VE 관리 IP에 VLAN 5 사용</point><br>
...
iface vmbr0 inet manual
        ...
        bridge-fd 0
```
<point>![](../_static/images/check.png) 예시: VLAN 인식 Linux 브릿지를 사용하여 Proxmox VE 관리 IP에 VLAN 5 사용</point><br>
...
<point>![](../_static/images/check.png) 예시: 기존 Linux 브릿지를 사용하여 Proxmox VE 관리 IP에 bond0을 사용하여 VLAN 5 사용</point><br>
...
> ![](../_static/images/check.png) 시스템을 Proxmox VE 7로 업그레이드하는 경우 <point>chrony, ntp</point> 또는 <point>openntpd</point> 중 하나를 수동으로 설치하는 것이 좋습니다.
<br>
...
<point>![](../_static/images/check.png) chrony를 사용하는 시스템의 경우:</point><br>
...
...
```
<point>![](../_static/images/check.png) systemd-timesyncd를 사용하는 시스템의 경우:</point><br>
...
> ![](../_static/images/check.png) 주의 <br>
...
> ![](../_static/images/check.png) 데이터 풀을 확장할 때는 메타데이터 풀도 확장해야 합니다.
<br>
...
<point>![](../_static/images/check.png) 일반적인 ZFS의 이점</point><br>
...
> ![](../_static/images/check.png) 자체 캐시 관리 기능이 있는 하드웨어 RAID 컨트롤러 위에 ZFS를 사용하지 마세요. ZFS는 디스크와 직접 통신해야 합니다. HBA 어댑터 또는 'IT' 모드로 플래시된 LSI 컨트롤러와 같은 것이 더 적합합니다.
...
<point>![](../_static/images/check.png) 성능</point><br>
...
<point>![](../_static/images/check.png) 크기, 공간 사용량 및 이중화</point><br>
